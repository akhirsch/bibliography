...
\begin{mathparpagebreakable}
  ...
  \and
  (\CtrlSeq{E_{1,1}}{E_{1,2}}) \ctrlmerge (\CtrlSeq{E_{2,1}}{E_{2,2}}) \defeq \CtrlSeq{E_{1,1} \ctrlmerge E_{2,1}}{E_{1,2} \ctrlmerge E_{2,2}}
  \and
  ...
  \and
  (E_1~t) \ctrlmerge (E_1~t) \defeq (E_1 \ctrlmerge E_2)~t
  \and
