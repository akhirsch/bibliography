...
\begin{mathparpagebreakable}
	...
	\infer[R-IfR]{}
	{\app{(\ell.\ifthen{C_1}{F_1}{F_2})}{C_2} \rewrite \ell.\ifthen{C_1}{(\app{F_1}{C_2})}{(\app{F_2}{C_2})}} \and

	\infer[R-IfL]{\spn{F} \cap \pn{C} = \varnothing}
	{\app{F}{(\ell.\ifthen{C}{C_1}{C_2})} \rewrite \ell.\ifthen{C}{(\app{F}{C_1})}{(\app{F}{C_2})}} \and
