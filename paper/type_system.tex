...
\begin{mathparpagebreakable}
  ...
  {\chortyped{\Gamma}{\Delta}{\Sigma}{\Fun{X\ty\tau_1}{C}}{\tau_1 \to \tau_2}}
  \and
...
%  \and
  ...
  \and
  \infer[TAbs]{\chorkinded{\Gamma, \alpha \knd \kappa}{\tau}{*} \\\\
...
\begin{thm}[Relative Preservation]
  ...
  If the local type system enjoys \textsc{Preservation}, then for every choreography $C_1$ such that $\chortyped{\Gamma}{\Delta}{\Sigma}{C_1}{\tau}$ and $C_1 \step{R} C_2$, we have that $\chortyped{\Gamma}{\Delta}{\Sigma}{C_2}{\tau}$.
\end{thm}
