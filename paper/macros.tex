...
\newcommand{\ChoiceCol}[1]{{\color{orangeGold}#1}}
...
\newcommand{\ChorDef}{\mathbin{\ChorCol{\coloneqq}}}
...
\newcommand{\CtrlDef}{\mathbin{\CtrlCol{\coloneqq}}}
...
\newcommand{\AmI}[3]{\FontCtrl{AmI}\CtrlCol{\in}~{#1}~\CtrlThen~{#2}~\CtrlElse~{#3}}
...
\newcommand{\AcquireWorker}{\programfont{acquireWorker}}
