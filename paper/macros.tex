...
\newcommand{\Typ}{\programfont{tyRep}}
\newcommand{\Loc}{\programfont{loc}}
\newcommand{\Empty}{\ensuremath{\mathbf{0}}}

\definecolor{orangeGold}{rgb}{0.67, 0.33, 0.1}
\newcommand{\ChoiceCol}[1]{{\color{Emerald}#1}}
\newcommand{\FontChoice}[1]{\ensuremath{\mathbf{\ChoiceCol{#1}}}}
...
\newcommand{\Fun}[3]{\mathop{\FunN}{#1}({#2}) \ChorDef {#3}}
...
\newcommand{\AmIN}{\FontCtrl{AmI}}
\newcommand{\AmIInN}{\AmIN\mathord{\CtrlCol{\in}}}
\newcommand{\CtrlIn}{\FontCtrl{in}}
\newcommand{\CtrlThen}{\FontCtrl{then}}
\newcommand{\CtrlElse}{\FontCtrl{else}}
\newcommand{\CtrlLeft}{\Left}
\newcommand{\CtrlRight}{\Right}
\newcommand{\CtrlFunN}{\FontCtrl{fun}}
\newcommand{\CtrlTFunN}{\CtrlCol{\Lambda}}

\newcommand{\CtrlLetIn}[3]{\FontCtrl{let}~{#1} \CtrlDef {#2}~\FontCtrl{in}~{#3}}
\newMLP*{\CtrlLetIn}[3]{\FontCtrl{let}~{#1} \CtrlDef {#2} \\ \FontCtrl{in}~{#3}}
\newcommand{\CtrlITE}[3]{\FontCtrl{if}~{#1}~\CtrlThen~{#2}~\CtrlElse~{#3}}
...
\newcommand{\AmI}[3]{\AmIN~{#1}~\CtrlThen~{#2}~\CtrlElse~{#3}}
\newMLP*{\AmI}[3]{\AmIN~{#1}~\CtrlThen~{#2} \\ \phantom{\AmIN~{#1}~{}}\CtrlElse~{#3}}
\newcommand{\AmIIn}[3]{\AmIInN~{#1}~\CtrlThen~{#2}~\CtrlElse~{#3}}
\newMLP{\MLAmIIn}[3]{\AmIInN~{#1} \\ \CtrlThen~{#2} \\ \CtrlElse~{#3}}
\newMLP*{\MLAmIIn}[3]{\AmIInN~{#1}~\CtrlThen~{#2} \\ \phantom{\AmIInN~{#1}~{}}\CtrlElse~{#3}}
%\newMLP*{\MLAmI}[3]{\AmIN~{#1}~\CtrlThen~{#2} \\ \phantom{\AmIN~{#1}~{}} \CtrlElse~{#3}}
\newcommand{\CtrlSeq}{\mathrel{\CtrlCol{;}}}
\newcommand{\IAm}[1]{\text{IAmIn}~{#1}}

\newcommand{\LocalLangFont}[1]{\programfont{#1}}
\newcommand{\True}{\LocalLangFont{true}}
\newcommand{\False}{\LocalLangFont{false}}
\newcommand{\CtrlFun}[3]{\mathop{\CtrlFunN} {#1}({#2}) \CtrlDef {#3}}
...
%% Example Names
\newcommand{\LocFont}[1]{\programfont{\color{orangeGold}#1}}
...
\newcommand{\AcquireWorker}{\LocFont{acquireWorker}}
\newcommand{\Pool}{\LocFont{pool}}
\newcommand{\ReleaseWorker}{\LocFont{releaseWorker}}
...
% Names
\newcommand{\langnameraw}{\ensuremath{\lambda}QC}
...
\newcommand{\ctrlsteploc}[2][]{\raw@step{#1}{}{}}
\newcommand{\ctrlstep}[1][]{\ctrlsteploc[#1]{L}}
