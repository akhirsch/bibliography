...
\newcommand{\leftjpquote}{\begin{CJK}{UTF8}{min}「\end{CJK}}
\newcommand{\rightjpquote}{\begin{CJK}{UTF8}{min}」\end{CJK}}
\newcommand{\sayam}[1]{\text{``#1''}}
...
\newcommand{\LetTellIn}[4]{\LetN~\Tell[#1]{#2}{#3}~\In~{#4}}
