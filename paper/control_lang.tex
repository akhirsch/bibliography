...
\begin{figure}
  \begin{syntax}
    ...
    \alternative{X} \alternative{\CtrlFail} \alternative{\Ret{e}} \alternative{E_1 \CtrlSeq E_2} \alternative{\CtrlFun{X}{E}} \alternative{\CtrlRec{X}{E}} \alternative{E_1~E_2} \\
...
\begin{mathparpagebreakable}
    ...
    {\Ret{e_1} \ctrlstep[\iota] \Ret{e_2}}
    \and
    \infer[Seq]{E_1 \ctrlstep[l] E_1'}
    {E_1 \CtrlSeq E_2 \ctrlstep[l] E_1' \CtrlSeq E_2}
    \and
    \infer[SeqV]{\text{Value}(V)}
    {V \CtrlSeq E \ctrlstep[\iota] E}
    \and
    \infer[AppFun]{E_1 \ctrlstep[l] E_1'}
    {E_1~E_2 \ctrlstep[l] E_1'~E_2}
    \and
    ...
    {(\CtrlFun{X}{E})~V \ctrlstep[\iotasync] \subst{E}{X}{V}}
    \and
    \infer[Rec]{~}
    {\mu X.E \ctrlstep[\iotasync] \subst{E}{X}{\mu X.E}}
    \and
    \infer[Send]{E \ctrlstep[l] E'}
    {\SendTo{E}{L'} \ctrlstep[l] \SendTo{E'}{L'}}
    \and
    \infer[SendV]{\text{Value}(v) \\
      L' \neq L}
    {\SendTo{\Ret{v}}{L'} \ctrlstep[v \sendsto L'] \CtrlFail}
    \and
    \infer[Recv]{\text{Value}(v) \\
      L' \neq L}
    {\RecvFrom{L'} \ctrlstep[L';v \sendsto] \Ret{v}}
    \and
    \infer[Choose]{L' \neq L}
    {\ChooseFor{d}{L'}{E} \ctrlstep[d \sendsto L'] E}
    \and
    \infer[AllowChoiceL]{L' \neq L}
    {\AllowChoice{L'}{E_1}{E_2} \ctrlstep[L';\Left \sendsto] E_1}
    \and
    \infer[AllowChoiceR]{L' \neq L}
    {\AllowChoice{L'}{E_1}{E_2} \ctrlstep[L';\Right \sendsto] E_2}
    \and
    \infer[If]{E \ctrlstep[l] E'}
    {\CtrlITE{E}{E_1}{E_2} \ctrlstep[l] \CtrlITE{E'}{E_1}{E_2}}
    \and
    \infer[IfT]{~}
    {\CtrlITE{\Ret{\True}}{E_1}{E_2} \ctrlstep[\iota] E_1}
    \and
    \infer[IfF]{~}
    {\CtrlITE{\Ret{\False}}{E_1}{E_2} \ctrlstep[\iota] E_2}
    \and
    \infer[AppTFun]{E \ctrlstep[l] E'}
    {E~t \ctrlstep[l] E'~t}
    \and
    \infer[AppT]{~}
    {(\CtrlTFun{\alpha}{E})~t \ctrlstep[\iotasync] \subst{E}{\alpha}{t}}
    \and
    \infer[LetRet]{E_1 \ctrlstep[l] E_1'}
    {\CtrlLetIn{\Ret{x}}{E_1}{E_2} \ctrlstep[l] \CtrlLetIn{\Ret{x}}{E_1'}{E_2}}
    \and
    \infer[LetRetV]{\text{Value}(v)}
    {\CtrlLetIn{\Ret{x}}{\Ret{v}}{E} \ctrlstep[\iota] \subst{E}{x}{v}}
    \and
    \infer[SendTy]{E_1 \ctrlstep[l] E_1'}
    {\LetSendIn{\alpha \knd \kappa}{E_1}{\rho}{E_2} \ctrlstep[l] \LetSendIn{\alpha \knd \kappa}{E_1'}{\rho}{E_2}}
    \and
    \infer[SendTyV]{~}
    {\LetSendIn{\alpha \knd \kappa}{\Ret{\say{t}}}{\rho}{E} \ctrlstep[L;t \sendsto \rho] \subst{E}{\alpha}{t}}
    \and
    \infer[RecvTy]{~}
    {\LetRecvIn{\alpha \knd \kappa}{L}{E} \ctrlstep[L';t \sendsto \{L\}] \subst{E}{\alpha}{t}}
    \and
    \infer[AmIL]{~}
    {\AmI{L}{E_1}{E_2} \ctrlstep[\iota] E_1}
    \and
    \infer[AmIR]{L' \neq L}
