...
\begin{mathparpagebreakable}
    ...
    {\CtrlSeq{V}{E} \ctrlstep[\iota] E} \and
    ...
    {\CtrlITE{E}{E_1}{E_2} \ctrlstep[l] \CtrlITE{E'}{E_1}{E_2}} \and
    
    \infer[IfT]{~}
    {\CtrlITE{\Ret{\True}}{E_1}{E_2} \ctrlstep[\iota] E_1} \and

    \infer[IfF]{~}
    {\CtrlITE{\Ret{\False}}{E_1}{E_2} \ctrlstep[\iota] E_2} \and

    \infer[AppTFun]{E \ctrlstep[l] E'}
    {E~t \ctrlstep[l] E'~t} \and

    \infer[AppT]{~}
    {(\CtrlTFun{\alpha}{E})~t \ctrlstep[\iotasync] \subst{E}{\alpha}{t}} \and
