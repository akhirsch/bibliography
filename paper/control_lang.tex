...
\begin{syntax}
\category[Label]{l}
\alternative{\iota} \alternative{V \sendsto L} \alternative{L;V \sendsto} \alternative{d \sendsto L} \alternative{L;d \sendsto} \alternative{t \sendsto \rho} \alternative{L;t \sendsto} \alternative{\IAm{L}}
\end{syntax}
...
\begin{mathparpagebreakable}
    ...
    \infer[AmIL]{}
    {\AmI{L}{E_1}{E_2} \ctrlstep[\IAm{L}] E_1} \and

    \infer[AmIR]{L \neq L'}
    {\AmI{L}{E_1}{E_2} \ctrlstep[\IAm{L'}] E_2} \and
