...
\begin{ex}[System F]
  \label{ex:system-f}
  System F with primitive types for booleans and integers, as well as a way to represent simple types denoted via the quotations \sayjp{\Int}, \say{\Bool}, and $e_1 \quoteto e_2$, satisfies our requirements.
