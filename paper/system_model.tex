...
\begin{figure}
	\begin{mathpar}
		...
		{\localctxwf{\Gamma}{\Sigma}} \and

		\infer[TyWf]{\localtyped{\Gamma}{\Sigma}{e}{t}}
		{\localkinded{\Gamma}{t}} \and
...
\begin{itemize}
	\item (\textsc{Preservation}) If $e_1 \localstep e_2$ and $\localtyped{\Gamma}{\Sigma}{e_1}{t}$, then $\localtyped{\Gamma_e}{\Sigma_e}{e_2}{t}$.
