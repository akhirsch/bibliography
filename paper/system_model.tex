...
These representations need not be in any specific format; they only need to satisfy a similar property to that of the synchronization messages which allows us to convert a representation into an actual location.
