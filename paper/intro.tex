...
Although locations can appear in the types of choreographic programs such as $\Int @ \Worker$, we disallow \emph{dependent types} within our language while still allowing the dynamic value of the location to be used in the body of the program
...
\begin{itemize}
  ...
  In particular, previous works (Alice \& Bob) have implemented process polymorphism using a variant of System $\text{F}_\omega$ which includes a \emph{type-conversion} rule, whereas \langname extends System F and does not require type-conversion.
	\item The metatheory of our syntax and type-system have been formalized and mechanically verified in Agda, and we present proofs for all remaining major theorems within this paper.
