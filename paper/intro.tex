...
\begin{align*}
  ...
  \end{array}
\end{align*}
\ashley{Walk through this program in more detail. E.g. F is a function stored at C, the let-expression lets the location access it in local expressions, etc}
