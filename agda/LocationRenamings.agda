...
renₗ ξ (If ℓ C C1 C2) = If (renₗ-Loc ξ ℓ) (renₗ ξ C) (renₗ ξ C1) (renₗ ξ C2)
renₗ ξ (Sync ℓ1 d ℓ2 C) = Sync (renₗ-Loc ξ ℓ1) d (renₗ-Loc ξ ℓ2) (renₗ ξ C)
renₗ ξ (DefLocal ℓ t C1 C2) = DefLocal (renₗ-Loc ξ ℓ) t (renₗ ξ C1) (renₗ ξ C2)
...
renExtₗ ξ1≈ξ2 (DefLocal ℓ t C1 C2) = cong₄ DefLocal (renExtₗ-Loc ξ1≈ξ2 ℓ) refl (renExtₗ ξ1≈ξ2 C1) (renExtₗ ξ1≈ξ2 C2)
...
renIdₗ (DefLocal ℓ t c c₁) = cong₄ DefLocal (renIdₗ-Loc ℓ) refl (renIdₗ c) (renIdₗ c₁)
...
renFuseₗ ξ1 ξ2 (DefLocal ℓ t c c₁) = cong₄ DefLocal (renFuseₗ-Loc ξ1 ξ2 ℓ) refl (renFuseₗ ξ1 ξ2 c) (renFuseₗ ξ1 ξ2 c₁)
