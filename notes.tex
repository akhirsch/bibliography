...
\begin{syntax}
	...
	\alternative{\alpha}
	\alternative{\ell.e}
	\alternative{\ell_1.e \rightsquigarrow \alpha @ \ell_2; C}\\
	...
	\alternative{C\;\ell}\\
	\alternative{\text{tell}\; X \in \{\ell_1,\ldots,\ell_n\} := \ell.e \;\text{do}\; C}
\end{syntax}
...
\begin{mathpar}
  ...
  \infer[Send]{\Theta \vdash \ell_1, \ell_2 \;\text{Loc} \\
    ...
    \Theta;(\Gamma, \alpha : t_1 @ \ell_2);(\Delta) \vdash C : \tau_2}
  ...
  \infer[TellDo]{\proj{\Delta}{\ell} \vdash e : \text{Loc} \\
    \Theta \vdash \tau \;\text{Ty} \\
    \Theta \vdash \ell_1,\ldots,\ell_n \;\text{Loc} \\
    (\Theta, X : \;\text{Loc});\Gamma;\Delta \vdash C : \tau}
  {\Gamma \vdash \text{tell}\; X \in \{\ell_1,\ldots,\ell_n\} := \ell.e \;\text{do}\; C : \tau}
\end{mathpar}
...
\begin{syntax}
	...
	\alternative{\text{Fun}}
	\alternative{\text{Loc}}\\
	\alternative{\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.(e_1 \Rightarrow e_2)}\\
	\alternative{\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.L_i}
\end{syntax}

\paragraph{Semantics}\;
Block-set semantics $C_1 \step{R}{\mathcal{B}} C_2$ where $C_1, C_2$ are \emph{closed} choreographies, $R$ is a redex, and $\mathcal{B} \subseteq \mathcal{L}$ is a set of concrete locations.
...
\begin{mathparpagebreakable}
  ...
  \infer[SendI]{C_1 \step{R}{\mathcal{B} \cup \{L_1,L_2\}} C_2}
  {L_1.e \rightsquigarrow \alpha @ L_2;C_1 \step{L_1.(e_1 \Rightarrow e_2) \rightsquigarrow L_2}{\mathcal{B}} L_1.e \rightsquigarrow \alpha @ L_2;C_2} \and
  ...
  \infer[TellDoE]{e_1 \Rightarrow_e e_2 \\
    L \notin \mathcal{B}}
  {\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.e_1 \;\text{do}\; C \step{\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.(e_1 \Rightarrow e_2)}{\mathcal{B}} \text{tell}\; X \in \{L_1,\ldots,L_n\} := L.e_2 \;\text{do}\; C}

  \infer[TellDoI]{C_1 \step{R}{\mathcal{B} \cup \{L, L_1,\ldots,L_n\}} C_2}
  {\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.e \;\text{do}\; C_1 \step{R}{\mathcal{B}} \text{tell}\; X \in \{L_1,\ldots,L_n\} := L.e \;\text{do}\; C_2}

  \infer[TellDoV]{L, L_1,\ldots,L_n \notin \mathcal{B}}
  {\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.L_i \;\text{do}\; C \step{\text{tell}\; X \in \{L_1,\ldots,L_n\} := L.L_i}{\mathcal{B}} C[X \mapsto L_i]}
