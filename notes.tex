...
\begin{syntax}
	...
	\\
	\abstractCategory[Choreography Variables]{\alpha, \beta}
...
\begin{mathpar}
  ...
  \infer[Fun]{\Theta;\Gamma;(\Delta, \alpha : \tau_1 \rightarrow \tau_2, \beta : \tau_1) \vdash C : \tau_2}
  {\Theta;\Gamma;\Delta  \vdash \text{fun}\; \alpha(\beta) := C : \tau_1 \rightarrow \tau_2} \and
