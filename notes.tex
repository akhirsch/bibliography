...
\begin{syntax}
  \category[Redeces]{R}
    ...
    \alternative{\text{SendE}\, p\, e_1\, e_2}
    \alternative{\text{SendV}\, p\, v}
...
\noindent\begin{mathpar}
  \infer{p \notin B\\ e_1 \To e_2} {p.e_1 \xRightarrow{\text{Done}\,p\,e_1\,e_2,~B} p.e_2} \and
  \infer{p \notin B\\ q \notin B\\ e_1 \To e_2}{\send{\own{p}{e_1}}{\own{q}{x}}; C \xRightarrow{\text{SendE}\,p\,e_1\,e_2,~B} \send{\own{p}{e_2}}{\own{q}{x}}; C} \and
  \infer{p \notin B\\\ q \notin B}{\send{\own{p}{v}}{\own{q}{x}}; C \xRightarrow{\text{SendV}\,p\,v,~B} \subst{C}{\own{q}{x}}{v}} \and
  ...
  \infer{ }{\clet{X}{C_1}{C_2} \xRightarrow{\text{Def},~B} \subst{C_2}{X}{\clet{X}{C_1}{C_1}}}
\end{mathpar}
...
\begin{proof}[Proof Sketch]
  \akh{I think we may have to make the final step and def step rules enforce $B = \varnothing$ to prove this.
    That would not affect any of the previous proofs in a serious way.}
